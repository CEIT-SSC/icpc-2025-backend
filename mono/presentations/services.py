...
def submit_registration(
    *,
    ...
    if len(valid_children) != len(child_ids):
        raise ValidationError("One or more selected child presentations are invalid.")
    ...
    if not created and reg.status in [Registration.Status.APPROVED, Registration.Status.FINAL]:
        raise ValidationError("You already have an approved/final registration for this presentation.")
